...
from seed import seed_authors, seed_quotes
...
class DataPipline:
    ...
    def close_spider(self, spider):
        ...
        seed_authors(AUTHORS_FILE)
        seed_quotes(QUOTES_FILE)
...
class QuotesSpider(scrapy.Spider):
    ...
    def parse(self, response, **kwargs):
        for q in response.xpath("/html//div[@class='quote']"):
            ...
            author = q.xpath("span/small[@class='author']/text()").get().strip().replace('-', ' ')
